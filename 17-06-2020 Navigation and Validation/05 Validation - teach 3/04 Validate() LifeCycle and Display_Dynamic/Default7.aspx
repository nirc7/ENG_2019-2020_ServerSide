<%@ Page Language="C#" AutoEventWireup="true"  ClientTarget ="DownLevel" CodeFile="Default7.aspx.cs" Inherits="_Default7" %>
...
<body>
    ...
    <table>
        <tr>
            <td>Name:</td>
            <td><asp:TextBox runat="server" ID="txtName" ontextchanged="txtName_TextChanged"></asp:TextBox></td>
