...
<body>
    ...
    <table>
        ...
        <tr>
            <td>Birth Year:</td>
            <td><asp:TextBox runat="server" ID="txtYear" ontextchanged="txtYear_TextChanged" AutoPostBack="true"></asp:TextBox></td>
            <td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ControlToValidate="txtYear" ErrorMessage="Please fill this field!" Text="*" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                Text="*" ForeColor="Red" Display="Dynamic" MaximumValue="2010" 
                MinimumValue="1970" Type="Integer" ErrorMessage="must be between 1970-2010"></asp:RangeValidator>
            </td>
        </tr>
        <tr>
            <td>Age:</td>
